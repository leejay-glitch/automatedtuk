...
if(isset($_POST['docsub']))
{
  ...
  $demail=$_POST['demail'];
  $query="insert into doctb(username,password,email)values('$doctor','$dpassword','$demail')";
...
if (isset($array['regno'])) {
  $regno = $array['regno'];
} else {
  $regno = ''; // or any other default value
}
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
    ...
    <div class="col-md-8"><input type="text" class="form-control" name="doctor" onkeydown="return alphaOnly(event);" required></div>

    <!-- <div class="col-md-4"><label>Specialization:</label></div> -->
    <!-- <div class="col-md-4"><label>Specialization:</label></div>
    <div class="col-md-8">
        <select name="special" class="form-control" id="special" required> -->
            <!-- <option value="head" selected>Select Specialization</option> -->
