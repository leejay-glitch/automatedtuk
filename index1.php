...
<html lang="en">
  ...
  <!-- styling patients login area -->
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp AUTOMATED TUK CLINIC</h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> Welcome to TUK clinic!</h4>
          </div>
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="func.php">
                <div class="row" style="margin-top: 10%">
                  <div class="col-md-4"><label>Regno: </label></div>
                  <div class="col-md-8"><input type="text" name="regno" class="form-control" placeholder="enter regno" required/></div><br><br>
