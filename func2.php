...
if(isset($_POST['patsub1'])){
  ...
  if (array_key_exists('regno', $_POST)) {
    ...
    // Handle the case where 'regno' is not set
    $regno = null; // Or some default value
}

  if($password==$cpassword){
  	$query="insert into patreg(fname,lname,gender,regno,contact,password,cpassword) values ('$fname','$lname','$gender','$regno','$contact','$password','$cpassword');";
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="post" action="appointment.php">
                <div class="row">
                  ...
                  <div class="col-md-4"><label>Regno id:</label></div>
                  <div class="col-md-8"><input type="text"  class="form-control" name="regno"></div><br><br>
